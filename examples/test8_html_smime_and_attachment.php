...
$brachioMailer->addAttachment('attachment.png', 'test8_image.png', 'image/png', 'Test image file.');
...
if (!$brachioMailer->Send('tester2@localhost.local', 'tester@localhost.local', 'test8', $messagehtml)) {
	echo 'Error<br />';
}
